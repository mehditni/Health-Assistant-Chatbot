...
public class BotData {
    ...
    private static String rhume = "fièvre,chaud,mal,gorge,éternuements,écoulement,nasal,légère,fatigue,rouge";
    ...
    private static String grippe = "fièvre,élevée,accélération,rythme,cardiaque,frissons,fatigue,abattement,somnolence,manque,d’appétit,nez,coule,mal,gorge,difficultés,avaler,voix,voilée,brûlures,thorax,toux,sèche.";
    ...
    private static String hypertension = "maux,tête,fatigue,nuque,tôt,matin,vertiges,bourdonnements,d'oreilles,palpitations,saignements,nez,confusion,somnolence,engourdissements,fourmillements,pieds";
    ...
    private static String thyroidite = "Fatigue,l’effort,cérébral,Prise,poids,Visage,bouffi,Doigts,boudinés,Constipation,Douleurs,articulaires,Sautes,d'humeur,Intolérance,tachycardies,Ralentissements,psychomoteurs,Maux,gorge";
    ...
    public static void VerifyQuestion(String message){
        ...
        if(message.equalsIgnoreCase("merci") || message.equalsIgnoreCase("d'accord"))
            thankyouvar +=1;
    ...
    public static String GetBestAnswer(String str){
        ...
        switch(Maladies.Maladie){
            ...
            case 996:
                ...
                try {
                    if(state == 0)
                        helo = "\uD83D\uDC4B Salut "+MainActivity.username.getText()+", je tiens à vous remercier pour la confiance que vous m'avez témoigné.\nPouvez-vous me citez vos symptoms pour commencer? ";
                    else
                        helo = "Vous êtes trop gentil "+MainActivity.username.getText()+", merci mais pouvez-vous me citez vos symptoms pour commencer?";
